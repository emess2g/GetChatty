  ...
  return chatUser ? (
    <div className='chat-box'>
      <div className="chat-user">
        ...
        <p>{chatUser.userData.name} <img className='img-dot' src={assets.green_dot} alt="" /></p>
      ...
      <div className="chat-input">
        <input onChange={(e) => setInput(e.target.value)} value={input} type="text" placeholder='sender a message' />
